...
class NotFoundResponseDetail2(Exception):
...
@dataclasses.dataclass
class NotFoundResponseDetail11:
    pass
...
@dataclasses.dataclass
class NotFoundResponse11(Exception):
    detail: Optional[Union[str, NotFoundResponseDetail2]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('detail'), 'exclude': lambda f: f is None }})
    r"""Contains parameter or domain specific information related to the error and why it occurred."""
