...
from ..shared import applicantsfilter as shared_applicantsfilter
from ..shared import getapplicantsresponse as shared_getapplicantsresponse
...
class ApplicantsAllRequest:
    ...
    filter: Optional[shared_applicantsfilter.ApplicantsFilter] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': True }})
    r"""Apply filters"""
...
class ApplicantsAllResponse:
    ...
    get_applicants_response: Optional[shared_getapplicantsresponse.GetApplicantsResponse] = dataclasses.field(default=None)
    r"""Applicants"""
