...
from ..shared import deleteapplicantresponse as shared_deleteapplicantresponse
...
class ApplicantsDeleteSecurity:
...
@dataclasses.dataclass
class ApplicantsDeleteResponse:
    content_type: str = dataclasses.field()
    r"""HTTP response content type for this operation"""
    status_code: int = dataclasses.field()
    r"""HTTP response status code for this operation"""
    delete_applicant_response: Optional[shared_deleteapplicantresponse.DeleteApplicantResponse] = dataclasses.field(default=None)
    r"""Applicants"""
